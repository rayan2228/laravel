                ...
                <form action="{{ route('restore.checked') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <button name="abc" value="1" type="submit" class="btn btn-success">Restore
                                    Checked</button>
                                <button name="abc" value="2" type="submit" class="btn btn-danger">Delete
                                    Checked</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                @forelse ($trashed as $sl=>$trash)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('uploads/category') }}/{{ $trash->category_image }}"
                                                alt=""></td>
                                        <td>
                                            <a title="restore" href="{{ route('category.restore', $trash->id) }}"
                                                class="btn btn-success btn-icon">
                                                <i data-feather="rotate-cw"></i>
                                            </a>
                                            <a data-link={{ route('hard.delete.category', $trash->id) }} title="delete"
