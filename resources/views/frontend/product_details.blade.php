                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <div class="comments-area">
                                                    ...
                                                    <div id="div-comment-1">
                                                        <div class="comment-theme">
                                                            <div class="comment-image">
                                                                ...
                                                                @else
                                                                    <img width="100" src="{{ asset('uploads/customer') }}/{{ $review->rel_to_customer->photo }}" alt="">
                                                                @endif
                                                            </div>
                                                        </div>
                                        ...
                                        @else
                                        <h3 class="bg-info text-center py-2 text-white">You Already Reviewed this product</h3>
                                        @endif
                                        @else
                                        <h3 class="bg-info text-center py-2 text-white">You did Not Purchase this product yet</h3>
                                        @endif
                                        @else
