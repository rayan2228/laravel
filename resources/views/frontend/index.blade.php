                ...
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        ...
                        <div class="content">
                            ...
                            <div class="price">
                                @if ($recent_added->discount)
                                    <span class="present-price">&#2547;{{ App\Models\Inventory::where('product_id', $recent_added->id)->first()->after_discount }}</span>
                                    <del class="old-price">&#2547;{{ App\Models\Inventory::where('product_id', $recent_added->id)->first()->price }}</del>
                                @else
                                     <span class="present-price">&#2547;{{ App\Models\Inventory::where('product_id', $recent_added->id)->first()->after_discount }}</span>
                                @endif
                            </div>
