                        ...
                        <form class="wpo-accountWrapper" action="{{ route('customerlogin') }}" method="POST">
                            ...
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    <a href="index.html"><img src="{{ asset('front') }}/images/logo-2.svg"
                                            alt=""></a>
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                @if (session('not_verified'))
                                    <div class="alert alert-danger">{{ session('not_verified') }} <a
                                            href="{{ route('customer.email.verify.req') }}">Didn't Get Verify
                                            Email?</a></div>
                                @endif
                                <div class="row">
