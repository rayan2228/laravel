                                    ...
                                    <div class="billing-adress" id="open4">
                                        <div class="contact-form form-style">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-12">
                                                    <select name="ship_country_id" id="ship_country" class="form-control">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-12">
                                                    <select name="ship_city_id" id="ship_city" class="form-control">
                            ...
                            <div class="oreder-item">
                                ...
                                <div class="oreder-product">
                                    ...
                                    <div class="product">
                                        <ul>
                                            ...
                                            <li>&#2547;{{ $cart->rel_to_inventory->where('product_id', $cart->product_id)->where('color_id', $cart->color_id)->where('size_id', $cart->size_id)->first()->after_discount }} x {{ $cart->quantity }}
                                            <li>
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <ul>
                                        ...
                                        <li class="free">
                                            <input id="Local" data-discount='{{ round(session('discount')) }}' class="charge" type="radio" name="charge" value="100">
