                        ...
                        <div class="col-lg-2">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="index.html"><img
                                        src="{{ asset('front') }}/images/logo.svg" alt="logo"></a>
                            </div>
                        </div>
                            ...
                            <form class="middle-box">
                                ...
                                <div class="search-box">
                                    <div class="input-group">
                                        ...
                                        <button id="search_btn" class="search-btn" type="button"> <i
                            ...
                            <div class="middle-right">
                                <ul>
                                    ...
                                    <li>
                                        @auth('customer')
                                            <div class="d-flex">
                                                <a href="{{ route('customer.profile') }}"><i title="Profile"
                                                        class="fi flaticon-user-profile"></i></a>
                                                    ...
                                                    @forelse (App\Models\Cart::where('customer_id', Auth::guard('customer')->id())->get() as $cart)
                                                        <div class="mini-cart-item clearfix">
                                                            ...
                                                            <div class="mini-cart-item-des">
                                                                ...
                                                                <span
                                                                    class="mini-cart-item-price">&#2547;{{ $cart->rel_to_inventory->where('product_id', $cart->product_id)->where('color_id', $cart->color_id)->where('size_id', $cart->size_id)->first()->after_discount }}
                                                                    x {{ $cart->quantity }}</span>
                                                                <span class="mini-cart-item-quantity"><a
                                                                        href="{{ route('cart.remove', $cart->id) }}"><i
                                                                            class="ti-close"></i></a></span>
                                                                <span><b>Color:
                                                                    </b>{{ $cart->rel_to_color->color_name }},
                                                                    <b>Size:</b>
                                                                    {{ $cart->rel_to_size->size_name }}</span>

                                                            </div>
                                                        </div>
                                                        @php
                                                            $sub_total +=
                                                                $cart->rel_to_inventory
                                                                    ->where('product_id', $cart->product_id)
                                                                    ->where('color_id', $cart->color_id)
                                                                    ->where('size_id', $cart->size_id)
                                                                    ->first()->after_discount * $cart->quantity;
                                                        @endphp
                                                    @empty
                        ...
                        <div class="row align-items-center">
                                        ...
                                        <ul id="metis-menu">
                                            @foreach (App\Models\Category::all() as $category)
                                                <li class="header-catagory-item">
                                                    <a class="menu-down-{{ App\Models\Subcategory::where('category_id', $category->id)->exists() ? 'arrow' : '' }}"
                            ...
                            <div class="col-lg-2 col-md-1 col-1">
                                <div class="header-right">
                                    <a href="{{ route('recent.views') }}" class="recent-btn"><i
                            ...
                            <div class="widget instagram">
                                ...
                                <ul class="d-flex">
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('front') }}/images/instragram/1.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('front') }}/images/instragram/2.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('front') }}/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('front') }}/images/instragram/3.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('front') }}/images/instragram/4.jpg"
                                                alt=""></a></li>
