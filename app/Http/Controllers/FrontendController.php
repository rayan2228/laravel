    ...
    function getSizes(Request $request)
    {
        ...
        foreach ($sizes as $size) {
            if ($size->rel_to_size->size_name == 'NA') {
                $str .= '<li class="color"><input class="sizes" checked id="sizes' . $size->size_id . '" type="radio" name="size_id" value="' . $size->size_id . '"><label for="sizes' . $size->size_id . '">' . $size->rel_to_size->size_name . '</label></li>';
            } else {
                $str .= '<li class="color"><input class="sizes" id="sizes' . $size->size_id . '" type="radio" name="size_id" value="' . $size->size_id . '"><label for="sizes' . $size->size_id . '">' . $size->rel_to_size->size_name . '</label></li>';
            }
        }
        echo $str;
    }
