...
class CustomerAuthController extends Controller
{
    ...
    function email_verify_req_send(Request $request)
    {
        ...
        return back()->with('verify_email', 'Verification email Sent! Please Verify your Email ');
    }
    function customer_store(Request $request)
    {
        ...
        return back()->with('registered', 'Customer Rgistration Successfully, Please Verify your Email to login');
    }
